...
import { faBuilding, faCircleCheck, faCompass, faCreditCard, faSpinner, faTriangleExclamation } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="page subscription-page">
      <div className="page-header">
        ...
        <div className="header-actions">
          <Link className="secondary-btn" to="/guide"><FontAwesomeIcon icon={faCompass} /> Guide entreprise</Link>
        </div>
      </div>
